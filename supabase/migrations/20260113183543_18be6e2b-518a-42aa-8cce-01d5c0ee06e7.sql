-- Update function to return only teams still alive in each playoff week
...
BEGIN
  ...
  ELSIF p_week = 2 THEN
    ...
    -- Get bye teams (teams in playoff_teams that didn't play in week 1)
    RETURN QUERY
    ...
    UNION
    -- Wild Card winners (from finished games)
    SELECT CASE 
